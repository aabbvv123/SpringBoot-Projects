			...
			<div class="col-5 border shadow p-3 mt-4">
				...
				<form action="update-student" method="post">
					<input type='text' class="form-control mt-2" placeholder="Enter Id"
						...
						value="<%=stu.getMono()%>"> <input type='text'
						class="form-control mt-2" placeholder="Enter Qualification"
						name="qualification" value="<%=stu.getQualification()%>">
					<input type='text' class="form-control mt-2"
						placeholder="Enter city" name="city" value="<%=stu.getCity()%>">
